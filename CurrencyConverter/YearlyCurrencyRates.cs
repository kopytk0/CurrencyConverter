...
namespace Jakubqwe.CurrencyConverter
{
    ...
    {
        private readonly Dictionary<ushort, decimal[]> _exchangeRatesInYear = new Dictionary<ushort, decimal[]>();
        ...
        public decimal GetRate(DateTime date)
        {
            ...
            return rate != default
                ? rate
                : throw new KeyNotFoundException("No exchange rate for day " + date.DayOfYear);
        }
